...
namespace IntelUniversity.Controllers
{
    public class InstructorsController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var instructor = await _context.Instructors.Include(i => i.OfficeAssignment).Include(i => i.CourseAssignments).ThenInclude(i => i.Course).AsNoTracking()
                .FirstOrDefaultAsync(m => m.ID == id);
            if (instructor == null)
            {
                return NotFound();
        ...
        public async Task<IActionResult> Edit(int? id, string[] selectedCourses)
        {
            ...
            if (await TryUpdateModelAsync<Instructor>(instructorToUpdate, "", i => i.FirstMidName,
        ...
        {
            Instructor instructor = await _context.Instructors.Include(i => i.CourseAssignments)
